...
<body>
        ...
        <div class="container">
            <div class="login-box ptb--100">
                <div class="progressOverlay" id="progressIndicator" style="visibility: hidden;">
                    <img src="../app/assets/images/progress.gif" width="64" height="64">
            </div>
                <form class="login100-form">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" onclick="Login();">Submit <i class="ti-arrow-right"></i></button>
                            <div id="wrongCredentials" class="alert alert-danger" style="visibility: hidden;text-align: center; margin-top:10px;">
    ...
    <script src="../app/assets/js/vendor/jquery-2.2.4.min.js"></script>
    <!-- bootstrap 4 js -->
